...
import lesson10.Expense;
import lesson10.ExpensesService;

import java.awt.event.ActionEvent;
import java.awt.event.ActionListener;
import java.sql.Date;

public abstract class SimpleCalculator extends JFrame { // interfaces
    ...
    public SimpleCalculator() {
        ...
        for (String label : buttonLabels) {
            ...
            button.addActionListener((ActionListener) this); // refers to the instance of the class that implements th ActionListener
                                            // interface
